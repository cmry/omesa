    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        <ul class="sidebar-menu">
          ...
          <li {{! 'class="active"' if page == 'Experiment' else ''}}><a href="exp"><i class="fa fa-flask"></i> <span>Experiment</span></a></li>
          <li {{! 'class="active"' if page == 'Results' else ''}}><a href="outp"><i class="fa fa-line-chart"></i> <span>Results</span></a></li>
