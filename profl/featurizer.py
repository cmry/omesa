...
from datareader import decode_frogstring
...
#     wordlist = decode_frogstring(frogstring)
...
#     tokens = [item[0] for item in wordlist if item[2].split('(')[0] in functors]
    
#     # Return the frequency dictionary of this token list
#     return freqdict(tokens)
